...
class ChatDetailPage extends StatefulWidget {
  final ChatModel chatModelDetail;
  const ChatDetailPage({required this.chatModelDetail});
          ...
          children: [
            CircleAvatar(
              ...
              backgroundImage: NetworkImage(
                widget.chatModelDetail.avatarUrl,
              ),
            ),
            const SizedBox(
              width: 8.0,
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    widget.chatModelDetail.username,
                    style: TextStyle(fontSize: 18.0),
                  ),
                  Text(
                    "Last seen today ${widget.chatModelDetail.time}  PM",
                    style: TextStyle(
                      fontSize: 14,
